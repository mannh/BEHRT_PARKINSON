...
class MLMLoader(Dataset):
    def __init__(self, dataframe, token2idx, age2idx, max_len, code='code', age='age', lab_test='Creatinine'):
        self.vocab = token2idx
        self.max_len = max_len
        self.code = dataframe[code]
        self.age = dataframe[age]
        self.age2idx = age2idx
        self.lab_test = dataframe[lab_test]
    ...
    def __getitem__(self, index):
        ...
        creatinine = self.lab_test[index][(-self.max_len + 1):]
